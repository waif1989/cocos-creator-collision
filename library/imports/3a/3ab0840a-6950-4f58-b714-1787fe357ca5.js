...
cc.Class({
	...
	spawnNewStar: function spawnNewStar() {
  	...
  	cc.moveTo(4, cc.p(this.node.width / 2, this.node.height / 2))
		...
		var actionAll = cc.spawn(cc.cardinalSplineTo(this.newRandomFunc(1.5, 1.8), [cc.p(this.leftOrRight * this.node.width / 2, this.newRandomFunc(this.groundY + 30, this.node.height / 4)), cc.p(this.leftOrRight * this.node.width / 4, this.node.height / 3), cc.p(this.newRandomFunc(0, -this.leftOrRight * this.node.width / 4), this.groundY)], 0), cc.rotateBy(2, 720));
